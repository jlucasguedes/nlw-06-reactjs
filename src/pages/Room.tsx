...
export function Room() {
  ...
  async function handleLikeQuestion(questionId: string, likeId: string | undefined) {
    ...
    const questionRemoveRef = ref(database, `rooms/${roomId}/questions/${questionId}/likes/${likeId}`);

    if (likeId) {
      await remove(questionRemoveRef);
    } else {
      await push(questionRef, { authorId: user?.id });
    }
